 ...
 */
@property (nonatomic) QLBSGPSType type;
/** @brief 纬度 */
 ...
 *	@brief 行政区号(像身份证号前6位) 
 */
@property (nonatomic) NSInteger districtCode;
/** 
 *	@brief 从高到低拼合地点信息
 *	@return 描述该地点的字符串指针
 */
...
/** @brief poiID */
@property (nonatomic) uint64_t poiID;
/** @brief 行政区划编码(与身份证号前6位意义相同) */
@property (nonatomic) int districtCode;
/** @brief 火星坐标点 */
@property (nonatomic, retain) QLBSGPSInfo* marsGps;
/** @brief 离输入点距离(单位:米) */

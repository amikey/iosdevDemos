...
// 开启以任意的GPS获取地理位置信息
#define QLBS_ENABLE_ARBITRARY_GPS_POSITION 1
...
/** @brief 获取当前位置信息 */
extern NSString* const QLBSSERVICE_GETPOSITION;
/** @brief 获取附近POI列表 */
extern NSString* const QLBSSERVICE_GETPOILIST;
/** @brief 搜索附近POI */
extern NSString* const QLBSSERVICE_SEARCHPOILIST;
